...
def parse_args():
    ...
    parser.add_argument("--do_predict", 
                        default=True,
                        action="store_true", help="To do prediction on the question answering model")
    parser.add_argument(
        "--validation_file", type=str, default=None, help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--test_file", type=str, 
        default='qa_test.json', help="A csv or a json file containing the Prediction data."
    )
    parser.add_argument(
        "--max_seq_length",
        type=int,
...
def main():
    ...
    if args.do_predict:
        ...
        with open(args.csv_file, 'w') as f:
            f.write('id,answer\n')
            for p in prediction:
                f.write(f'{p["id"]},"{p["prediction_text"]}"\n')
