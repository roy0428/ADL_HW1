...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='ntuadl2023hw1/valid.json', 
    ...
    parser.add_argument("--output_dir", type=str, 
                        default='result_1', help="Where to store the final model.")
...
def main():
    ...
    label_column_name = "relevant" ##if "relevant" in column_names else "labels"
    ...
    def preprocess_function(examples):
        ...
        # ipdb.set_trace()
        second_sentences = [
            [f"{data[index]}" for index in header] for i, header in enumerate(question_headers)
        ]
        # ipdb.set_trace()
        # labels = examples[label_column_name]
        labels = [sublist.index(examples[label_column_name][index]) for index, sublist in enumerate(question_headers)]
        # ipdb.set_trace() 
        # Flatten out
